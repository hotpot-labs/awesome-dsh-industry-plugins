...
- **校验对象**: https://github.com/173787247/dsh-wsl-clipboard
- **校验时间**: 2026-08-31 04:25:55
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 178; 包名: dsh-wsl-clipboard; 描述: DeepSeek Harness tool: read/write the Windows clipboard from WSL. — README 包含功能/使用说明 |
...
| 3.7 | 不读取敏感配置 | 必查 | ⚠️  需人工复核 | 检测到敏感配置读取:<br>  - SECURITY.md:3 → 敏感凭证读取 (2 处)<br>  - CONTRIBUTING.md:5 → 敏感凭证读取 (1 处)<br>  - README.md:22 → 敏感凭证读取 (1 处)<br>  - index.js:24 → 敏感凭证读取 (1 处) — 需人工判断是否读取的是当前会话上下文 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 241, 注释行: 1 (0.4%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-wsl-clipboard |
| 校验 URL | https://github.com/173787247/dsh-wsl-clipboard |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
