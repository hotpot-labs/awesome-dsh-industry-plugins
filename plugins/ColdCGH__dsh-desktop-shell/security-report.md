...
- **校验对象**: https://github.com/ColdCGH/dsh-desktop-shell
- **校验时间**: 2026-08-30 04:22:45
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2018-08-14 (2937 天前); 公开仓库数: 18; 粉丝数: 1 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 179; 包名: @coldcgh/dsh-desktop-shell; 描述: dsh desktop shell: wrap the running dsh web (Harness) into a real desktop client — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:39 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:47 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - lib/index.js:65 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - lib/index.js:65 → fetch 网络请求 (1 处)<br>涉及的域名: 127.0.0.1, github.com, registry.npmjs.org<br>需人工确认每个网络请求的用途是否明确 |
...
| 6.2 | 不修改系统配置 | 必查 | ❌ 不通过 | 检测到系统配置修改:<br>  - scripts/update-client.sh:1 → 修改系统目录 (1 处) |
...
| 校验 URL | https://github.com/ColdCGH/dsh-desktop-shell |
| 必查项通过率 | 23/33 (70%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
