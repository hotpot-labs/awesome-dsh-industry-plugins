...
- **校验对象**: https://github.com/lengquan88/dsh-dual-auto
- **校验时间**: 2026-08-25 01:26:09
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2026-05-15 (101 天前); 公开仓库数: 4; 粉丝数: 1 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 197; 包名: @lengquan88/dsh-dual-auto; 描述: 双模型 Auto 路由插件: flash 低成本直返 / pro 高成本升级 + 逃逸学习闭环 + 持久化互通 — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 24 处, 函数: 88 个, 比例: 27.3% |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:10 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:42 → 探测到 HTTP(S) 网络请求 (2 处)<br>涉及的域名: atomgit.com, github.com, www.npmjs.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 988, 注释行: 27 (2.7%) |
...
| :--- | :--- |
| 插件名称 | dsh-dual-auto |
| 校验 URL | https://github.com/lengquan88/dsh-dual-auto |
| 必查项通过率 | 28/33 (85%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
