...
- **校验对象**: https://github.com/Boliban/dsh-enter-customizer
- **校验时间**: 2026-08-23 14:28:31
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2025-02-03 (566 天前); 公开仓库数: 7; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 214; 包名: dsh-enter-customizer; 描述: DSH web plugin: customize the chat composer input shortcuts (Enter / Ctrl+Enter  — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/dsh-settings: ^0.1.0-rc.6; @deepseek-ai/cordis: ^4.0.1 |
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ✅ 通过 | dsh 配置: {"client": {"platform": "web", "inject": ["slots", "sessions", "timer", "connection", "remote", "set; Cordis/DSH 依赖: @deepseek-ai/dsh-settings, @deepseek-ai/cordis; Cordis 配置文件: cordis.patch.yml |
| 2.3 | 具备异常捕获机制 | 必查 | ⚠️  需人工复核 | try/catch: 4 处, 函数: 44 个, 比例: 9.1% — try/catch 覆盖比例较低 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 389, 注释行: 30 (7.7%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-enter-customizer |
| 校验 URL | https://github.com/Boliban/dsh-enter-customizer |
| 必查项通过率 | 30/33 (91%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🟡 灰名单 (需人工复核) |
| 主要风险说明 | 详见各检查项结果 |
