...
- **校验对象**: https://github.com/dingyi580/dsh-plugin-gemini-theme
- **校验时间**: 2026-09-01 04:12:12
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2020-04-16 (2328 天前); 公开仓库数: 5; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 387; 包名: dsh-plugin-gemini-theme; 描述: A Gemini-styled skin for the DeepSeek Harness web client: one stylesheet layered — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:39 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - README.md:5 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.zh.md:5 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 41, 注释行: 10 (24.4%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-plugin-gemini-theme |
| 校验 URL | https://github.com/dingyi580/dsh-plugin-gemini-theme |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
