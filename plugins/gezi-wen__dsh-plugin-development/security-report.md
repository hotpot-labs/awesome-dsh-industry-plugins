...
- **校验对象**: https://github.com/gezi-wen/dsh-plugin-development
- **校验时间**: 2026-09-16 03:59:38
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 94; 包名: dsh-plugin-development; 描述: Ships a skill that documents how to build, debug and publish DSH plugins, and re — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:29 → 探测到 HTTP(S) 网络请求 (2 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-plugin-development |
| 校验 URL | https://github.com/gezi-wen/dsh-plugin-development |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
