...
- **校验对象**: https://github.com/Waldsatte/dsh-theme-taojian
- **校验时间**: 2026-09-05 03:35:38
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2022-09-18 (1447 天前); 公开仓库数: 3; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ⚠️  需人工复核 | README 字数: 66; 包名: dsh-theme-taojian; 描述: Taojian (陶笺) — Claude-inspired DSH theme: warm paper #F5F3EE, clay accent #DA775 — README 缺少功能/使用说明, 需人工比对 |
...
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ✅ 通过 | dsh 配置: {"bundle": {"patch": "./cordis.patch.yml"}, "client": {"inject": ["theme"], "platform": "web"}}; Cordis 配置文件: cordis.patch.yml |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 205, 注释行: 7 (3.4%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-theme-taojian |
| 校验 URL | https://github.com/Waldsatte/dsh-theme-taojian |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
