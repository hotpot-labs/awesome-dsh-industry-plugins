...
- **校验对象**: https://github.com/bycall/dsh-engineer-tools
- **校验时间**: 2026-09-19 03:48:08
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2015-10-08 (3998 天前); 公开仓库数: 10; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 272; 包名: dsh-engineer-tools; 描述: Engineering work-tools for DeepSeek Harness: a scoped git runner and a package-m — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; @deepseek-ai/dsh-tools: ^0.1.0-rc.7 \|\| ^0.1.2-alpha.1 \|\| ^0.1.3-alpha.1 \|\| ^0.1.5-rc.1 \|\| ^0.1.6-alpha.1; engines: {"node": ">=18"} |
...
| 2.3 | 具备异常捕获机制 | 必查 | ⚠️  需人工复核 | try/catch: 1 处, 函数: 16 个, 比例: 6.2% — try/catch 覆盖比例较低 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:7 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - package-lock.json:25 → 探测到 HTTP(S) 网络请求 (23 处)<br>涉及的域名: github.com, registry.npmjs.org<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 322, 注释行: 50 (15.5%) |
...
| 5.4 | 无未授权读取 | 必查 | ⚠️  需人工复核 | 检测到潜在未授权读取:<br>  - test/smoke.mjs:83 → 读取 git 历史 (1 处) — 需人工判断是否在授权范围内 |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-engineer-tools |
| 校验 URL | https://github.com/bycall/dsh-engineer-tools |
| 必查项通过率 | 28/33 (85%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
