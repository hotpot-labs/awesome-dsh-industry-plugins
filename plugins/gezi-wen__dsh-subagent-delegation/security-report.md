...
- **校验对象**: https://github.com/gezi-wen/dsh-subagent-delegation
- **校验时间**: 2026-09-19 03:48:32
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 83; 包名: dsh-subagent-delegation; 描述: Ships a skill that tells the agent when to delegate work to subagents instead of — README 包含功能/使用说明 |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-subagent-delegation |
| 校验 URL | https://github.com/gezi-wen/dsh-subagent-delegation |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
