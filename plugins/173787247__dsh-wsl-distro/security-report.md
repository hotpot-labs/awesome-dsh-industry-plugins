...
- **校验对象**: https://github.com/173787247/dsh-wsl-distro
- **校验时间**: 2026-08-31 04:25:59
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 91; 包名: dsh-wsl-distro; 描述: DeepSeek Harness plugin: current WSL distro facts and multi-distro warnings. — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 4 处, 函数: 19 个, 比例: 21.1% |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 3.1 | 文件系统权限最小化 | 必查 | ❌ 不通过 | 检测到敏感路径访问:<br>  - lib/distro.js:7 → 读取环境变量配置 (1 处)<br>  - lib/wsl-host.js:19 → 读取环境变量配置 (1 处) |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 186, 注释行: 0 (0.0%) |
...
| 6.2 | 不修改系统配置 | 必查 | ❌ 不通过 | 检测到系统配置修改:<br>  - lib/distro.js:13 → 修改系统目录 (1 处) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-distro |
| 校验 URL | https://github.com/173787247/dsh-wsl-distro |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
