...
- **校验对象**: https://github.com/shawnlone/dsh-theme-tuner
- **校验时间**: 2026-08-28 10:31:33
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2018-11-26 (2832 天前); 公开仓库数: 42; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 207; 包名: dsh-theme-tuner; 描述: DSH web plugin: theme customization placed under the built-in Appearance (外观) se — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; @deepseek-ai/dsh-client-locale: ^0.1.1-rc.2; @deepseek-ai/dsh-client-runtime: ^0.1.1-rc.2; @deepseek-ai/dsh-client-ui-settings: ^0.1.1-rc.2; @deepseek-ai/dsh-client-ui-slots: ^0.1.1-rc.2 |
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ⚠️  需人工复核 | dsh 配置: {"bundle": {"patch": "./cordis.patch.yml"}, "client": {"inject": ["@deepseek-ai/dsh-client-modules",; Cordis/DSH 依赖: @deepseek-ai/cordis, @deepseek-ai/dsh-client-locale, @deepseek-ai/dsh-client-runtime, @deepseek-ai/dsh-client-ui-settings, @deepseek-ai/dsh-client-ui-slots; Cordis 配置文件: cordis.patch.yml<br>  - cordis.patch.yml:9 → Monkey patch / prototype pollution — 发现潜在 hack 模式, 需人工确认 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:47 → 探测到 HTTP(S) 网络请求 (3 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 625, 注释行: 96 (15.4%) |
...
| 6.2 | 不修改系统配置 | 必查 | ❌ 不通过 | 检测到系统配置修改:<br>  - scripts/install.ps1:1 → 修改系统目录 (1 处)<br>  - scripts/install.sh:1 → 修改系统目录 (1 处) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-theme-tuner |
| 校验 URL | https://github.com/shawnlone/dsh-theme-tuner |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
