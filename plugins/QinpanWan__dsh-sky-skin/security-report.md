...
- **校验对象**: https://github.com/QinpanWan/dsh-sky-skin
- **校验时间**: 2026-09-24 03:49:14
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - LICENSE:4 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - package.json:40 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - lib/client.js:945 → fetch 网络请求 (3 处)<br>  - lib/index.js:120 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - assets/tgc-sky-poster.jpg:3 → 探测到 HTTP(S) 网络请求 (2 处)<br>涉及的域名: github.com, x<br>需人工确认每个网络请求的用途是否明确 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 7.1 | 近 3 个月内有更新 | 必查 | ✅ 通过 | 最近提交距今: 29 天; 提交总数: 12 |
...
| :--- | :--- |
| 插件名称 | dsh-sky-skin |
| 校验 URL | https://github.com/QinpanWan/dsh-sky-skin |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
