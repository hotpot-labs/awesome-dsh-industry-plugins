...
- **校验对象**: https://github.com/Nanmu-del/dsh-plan-toggle
- **校验时间**: 2026-09-12 03:46:17
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2024-08-19 (753 天前); 公开仓库数: 6; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 416; 包名: @dsh-external/dsh-plan-toggle; 描述: DSH web client plugin: a persistent plan-mode toggle button in the composer tool — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 159, 注释行: 16 (10.1%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-plan-toggle |
| 校验 URL | https://github.com/Nanmu-del/dsh-plan-toggle |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
