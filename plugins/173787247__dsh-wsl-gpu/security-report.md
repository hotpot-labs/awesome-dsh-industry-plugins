...
- **校验对象**: https://github.com/173787247/dsh-wsl-gpu
- **校验时间**: 2026-08-31 04:26:04
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 103; 包名: dsh-wsl-gpu; 描述: DeepSeek Harness tool: probe nvidia-smi / GPU visibility inside WSL. — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 5 处, 函数: 18 个, 比例: 27.8% |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 185, 注释行: 0 (0.0%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-gpu |
| 校验 URL | https://github.com/173787247/dsh-wsl-gpu |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
