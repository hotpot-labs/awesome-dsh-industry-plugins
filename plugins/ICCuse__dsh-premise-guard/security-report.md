...
- **校验对象**: https://github.com/ICCuse/dsh-premise-guard
- **校验时间**: 2026-08-23 16:31:11
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 300; 包名: dsh-premise-guard; 描述: Post-compaction premise-drift guard plugin for DeepSeek Harness: after a compact — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ❌ 不通过 | try/catch: 0 处, 函数: 101 个, 比例: 0.0% — 未检测到任何 try/catch |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 1012, 注释行: 296 (29.2%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-premise-guard |
| 校验 URL | https://github.com/ICCuse/dsh-premise-guard |
| 必查项通过率 | 28/33 (85%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
