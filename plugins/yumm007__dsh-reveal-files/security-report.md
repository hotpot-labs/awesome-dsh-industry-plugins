...
- **校验对象**: https://github.com/yumm007/dsh-reveal-files
- **校验时间**: 2026-08-26 01:29:37
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2010-10-31 (5777 天前); 公开仓库数: 31; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 904; 包名: dsh-reveal-files; 描述: DeepSeek Harness plugin: adds a folder icon next to the produced-files row that  — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; engines: {"node": ">=22.6.0"} |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 16 处, 函数: 52 个, 比例: 30.8% |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - client/client.js:110 → fetch 网络请求 (1 处)<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 591, 注释行: 98 (16.6%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-reveal-files |
| 校验 URL | https://github.com/yumm007/dsh-reveal-files |
| 必查项通过率 | 29/33 (88%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
