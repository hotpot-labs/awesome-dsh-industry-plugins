...
- **校验对象**: https://github.com/173787247/dsh-wsl-port
- **校验时间**: 2026-08-31 04:26:14
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 110; 包名: dsh-wsl-port; 描述: DeepSeek Harness tool: diagnose WSL port listening and Windows localhost forward — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:8 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - README.md:5 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - README.zh.md:5 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - lib/port.js:43 → 探测到 HTTP(S) 网络请求 (2 处)<br>涉及的域名: 127.0.0.1, github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-port |
| 校验 URL | https://github.com/173787247/dsh-wsl-port |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
