...
- **校验对象**: https://github.com/AKS1st/dock-images
- **校验时间**: 2026-08-23 14:22:13
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 177; 包名: dock-images; 描述: Image viewer for the dock file explorer: renders PNG, JPEG, GIF, WebP, BMP, SVG, — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 16 处, 函数: 110 个, 比例: 14.5% |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.en.md:24 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - package.json:8 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - package-lock.json:42 → 探测到 HTTP(S) 网络请求 (93 处)<br>  - README.md:24 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - src/index.ts:161 → 探测到 HTTP(S) 网络请求 (3 处)<br>涉及的域名: dsh.internal, github.com, opencollective.com, registry.npmmirror.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 1403, 注释行: 401 (28.6%) |
...
| :--- | :--- |
| 插件名称 | dock-images |
| 校验 URL | https://github.com/AKS1st/dock-images |
| 必查项通过率 | 29/33 (88%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
