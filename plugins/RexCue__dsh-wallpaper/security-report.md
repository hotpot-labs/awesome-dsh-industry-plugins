...
- **校验对象**: https://github.com/RexCue/dsh-wallpaper
- **校验时间**: 2026-09-24 03:49:17
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2017-08-11 (3331 天前); 公开仓库数: 2; 粉丝数: 2 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 219; 包名: dsh-wallpaper; 描述: Wallpaper skin for the DeepSeek Harness web UI: image background with opacity, m — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - client.js:129 → 探测到 HTTP(S) 网络请求 (2 处)<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 726, 注释行: 81 (11.2%) |
...
| 5.3 | 敏感信息加密存储 | 必查 | ⚠️  需人工复核 | 检测到敏感信息存储:<br>  - client.js:58 → 明文写入敏感信息 (1 处) — 需确认是否加密存储 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 7.1 | 近 3 个月内有更新 | 必查 | ✅ 通过 | 最近提交距今: 40 天; 提交总数: 1 |
...
| :--- | :--- |
| 插件名称 | dsh-wallpaper |
| 校验 URL | https://github.com/RexCue/dsh-wallpaper |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
