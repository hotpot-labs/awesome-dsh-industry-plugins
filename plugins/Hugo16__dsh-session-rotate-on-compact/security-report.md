...
- **校验对象**: https://github.com/Hugo16/dsh-session-rotate-on-compact
- **校验时间**: 2026-09-20 04:01:05
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2016-12-12 (3568 天前); 公开仓库数: 16; 粉丝数: 1 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 55; 包名: dsh-session-rotate-on-compact; 描述: Rotate only the outbound LLM session id after each successful DSH compaction wit — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 1 处, 函数: 7 个, 比例: 14.3% |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.md:18 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 81, 注释行: 7 (8.6%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-session-rotate-on-compact |
| 校验 URL | https://github.com/Hugo16/dsh-session-rotate-on-compact |
| 必查项通过率 | 28/33 (85%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
