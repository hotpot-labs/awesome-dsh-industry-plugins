...
- **校验对象**: https://github.com/WODE25500/dsh-wsl
- **校验时间**: 2026-09-02 03:36:40
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 263; 包名: dsh-wsl; 描述: WSL (Windows Subsystem for Linux) bridge for DeepSeek Harness: run Linux command — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.en.md:8 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:6 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 222, 注释行: 30 (13.5%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl |
| 校验 URL | https://github.com/WODE25500/dsh-wsl |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
