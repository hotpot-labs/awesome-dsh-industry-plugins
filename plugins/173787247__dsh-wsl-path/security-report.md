...
- **校验对象**: https://github.com/173787247/dsh-wsl-path
- **校验时间**: 2026-08-31 04:26:12
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 120; 包名: dsh-wsl-path; 描述: DeepSeek Harness tool: convert WSL Linux and Windows paths with /mnt/c caveats. — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 3.1 | 文件系统权限最小化 | 必查 | ❌ 不通过 | 检测到敏感路径访问:<br>  - lib/wsl-host.js:19 → 读取环境变量配置 (1 处)<br>  - lib/path.js:4 → 读取环境变量配置 (1 处) |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 242, 注释行: 4 (1.7%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-path |
| 校验 URL | https://github.com/173787247/dsh-wsl-path |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
