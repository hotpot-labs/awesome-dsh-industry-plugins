...
- **校验对象**: https://github.com/AKS1st/dsh-cyber-particle
- **校验时间**: 2026-08-23 14:22:27
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 210; 包名: cyber-particle; 描述: Particle-network background overlay for the DeepSeek Harness Web shell (browser- — README 包含功能/使用说明 |
| 1.5 | 不违反法律法规 | 必查 | ✅ 通过 | 未检测到明显的违法违规模式 |
| 1.6 | 有明确的版本号与正式 Release | 推荐 | ✅ 通过 | Git tags (6): v0.2.3, v0.2.2, v0.2.1, v0.2.0, v0.1.1; package.json version: 0.2.3 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:37 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:35 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 445, 注释行: 31 (7.0%) |
...
| 5.3 | 敏感信息加密存储 | 必查 | ⚠️  需人工复核 | 检测到敏感信息存储:<br>  - client.js:118 → 明文写入敏感信息 (1 处) — 需确认是否加密存储 |
...
| 7.6 | 有社区背书 | 推荐 | ⚠️  需人工复核 | Stars: 11, Forks: 0, Watchers: 0 — 有一定社区基础 |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-cyber-particle |
| 校验 URL | https://github.com/AKS1st/dsh-cyber-particle |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
