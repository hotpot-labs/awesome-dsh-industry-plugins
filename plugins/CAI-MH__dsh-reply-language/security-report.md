...
- **校验对象**: https://github.com/CAI-MH/dsh-reply-language
- **校验时间**: 2026-09-07 03:34:07
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 190; 包名: dsh-reply-language; 描述: 强制大模型使用指定语言（默认中文）回复，可随时用工具切换 — DSH bundle。 — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 67, 注释行: 3 (4.5%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-reply-language |
| 校验 URL | https://github.com/CAI-MH/dsh-reply-language |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
