...
- **校验对象**: https://github.com/Jaylor-Wang/dsh-awesome-agent-preset
- **校验时间**: 2026-09-26 04:07:05
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2025-12-13 (286 天前); 公开仓库数: 5; 粉丝数: 1 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 169; 包名: dsh-awesome-agent-preset; 描述: Ultra-lean daily coding agent preset for DeepSeek Harness (dsh): direct tools ov — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.zh.md:5 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - README.md:5 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - package.json:9 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-awesome-agent-preset |
| 校验 URL | https://github.com/Jaylor-Wang/dsh-awesome-agent-preset |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
