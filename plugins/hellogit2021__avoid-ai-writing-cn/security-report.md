...
- **校验对象**: https://github.com/hellogit2021/avoid-ai-writing-cn
- **校验时间**: 2026-09-07 03:38:16
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2021-08-03 (1860 天前); 公开仓库数: 2; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 66; 包名: avoid-ai-writing-cn; 描述: 中文写作去 AI 味（AI-isms / AI writing / humanize）技能插件：说“去掉AI味”即重写，说“写的不错”自动把新 AI 词汇记入规 — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - marketplace-entry.json:4 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:6 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - skills/avoid-ai-writing-cn/SKILL.md:27 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com, www.zhihu.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 22, 注释行: 5 (22.7%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | avoid-ai-writing-cn |
| 校验 URL | https://github.com/hellogit2021/avoid-ai-writing-cn |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
