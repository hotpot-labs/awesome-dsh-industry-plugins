...
- **校验对象**: https://github.com/173787247/dsh-wsl-dns
- **校验时间**: 2026-09-02 03:32:00
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 52; 包名: dsh-wsl-dns; 描述: Compare WSL vs Windows DNS resolution for common endpoints. — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 190, 注释行: 0 (0.0%) |
...
| 6.2 | 不修改系统配置 | 必查 | ❌ 不通过 | 检测到系统配置修改:<br>  - lib/dns.js:63 → 修改系统目录 (1 处) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-dns |
| 校验 URL | https://github.com/173787247/dsh-wsl-dns |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
