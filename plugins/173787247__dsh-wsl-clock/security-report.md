...
- **校验对象**: https://github.com/173787247/dsh-wsl-clock
- **校验时间**: 2026-09-02 03:31:57
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 56; 包名: dsh-wsl-clock; 描述: Detect WSL2 clock drift that breaks TLS and tokens after sleep. — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 3 处, 函数: 19 个, 比例: 15.8% |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 162, 注释行: 0 (0.0%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-clock |
| 校验 URL | https://github.com/173787247/dsh-wsl-clock |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
