...
- **校验对象**: https://github.com/Chu-Xin-r/wanjiqi-meme
- **校验时间**: 2026-08-23 14:31:34
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2022-01-12 (1683 天前); 公开仓库数: 10; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 225; 包名: wanjiqi-meme; 描述: Wanjiqi (6657 live room) meme Skill for DeepSeek Harness (DSH): 22,771 real barr — README 包含功能/使用说明 |
| 1.5 | 不违反法律法规 | 必查 | ❌ 不通过 | 检测到潜在违规模式:<br>  - README.md:16 → 非法爬取 (2 处)<br>  - skills/wanjiqi-meme/assets/memes_top500.json:1 → 欺诈行为 (1 处) |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:19 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - README.md:9 → 探测到 HTTP(S) 网络请求 (5 处)<br>涉及的域名: agentskills.io, github.com, img.shields.io, sb6657.cn<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 158, 注释行: 7 (4.4%) |
...
| :--- | :--- |
| 插件名称 | wanjiqi-meme |
| 校验 URL | https://github.com/Chu-Xin-r/wanjiqi-meme |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
