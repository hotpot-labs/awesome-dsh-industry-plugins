...
- **校验对象**: https://github.com/WongYuYe/dsh-composer-recall
- **校验时间**: 2026-09-08 03:40:57
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2016-11-23 (3575 天前); 公开仓库数: 5; 粉丝数: 8 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 280; 包名: dsh-composer-recall; 描述: Arrow-key input history for DSH 0.1.2-alpha.1: press ↑ in an empty composer (or  — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; @deepseek-ai/dsh-client-ui-conversation: >=0.1.2-alpha.1 <0.2.0-0; engines: {"node": ">=20"} |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.zh-CN.md:3 → 探测到 HTTP(S) 网络请求 (4 处)<br>  - package.json:24 → 探测到 HTTP(S) 网络请求 (4 处)<br>  - README.md:3 → 探测到 HTTP(S) 网络请求 (4 处)<br>涉及的域名: awesome-dsh-plugin.com, github.com, registry.npmjs.org<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 199, 注释行: 20 (10.1%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-composer-recall |
| 校验 URL | https://github.com/WongYuYe/dsh-composer-recall |
| 必查项通过率 | 29/33 (88%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
