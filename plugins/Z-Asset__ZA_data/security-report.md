...
- **校验对象**: https://github.com/Z-Asset/ZA_data
- **校验时间**: 2026-09-19 03:47:43
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 98; 包名: @zasset/za-data; 描述: Z Research data stage — data discovery and quality assessment for asset pricing  — README 包含功能/使用说明 |
| 1.5 | 不违反法律法规 | 必查 | ❌ 不通过 | 检测到潜在违规模式:<br>  - skills/za-data/references/agents/explorer.md:24 → 非法爬取 (1 处) |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:59 → 探测到 HTTP(S) 网络请求 (2 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 244, 注释行: 28 (11.5%) |
...
| :--- | :--- |
| 插件名称 | ZA_data |
| 校验 URL | https://github.com/Z-Asset/ZA_data |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
