...
- **校验对象**: https://github.com/173787247/dsh-wsl-editor
- **校验时间**: 2026-09-02 03:32:07
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 55; 包名: dsh-wsl-editor; 描述: Open a WSL Linux path in Windows Cursor/VS Code/Notepad. — README 包含功能/使用说明 |
...
| 3.2 | 无全局文件读写 | 必查 | ⚠️  需人工复核 | 检测到全局文件访问:<br>  - lib/editor.js:53 → 读取用户主目录 (1 处) — 需人工判断是否有业务必要性 |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-editor |
| 校验 URL | https://github.com/173787247/dsh-wsl-editor |
| 必查项通过率 | 25/33 (76%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
