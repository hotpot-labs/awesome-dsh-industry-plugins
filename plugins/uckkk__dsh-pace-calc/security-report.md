...
- **校验对象**: https://github.com/uckkk/dsh-pace-calc
- **校验时间**: 2026-08-25 01:28:11
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2015-04-29 (4135 天前); 公开仓库数: 1394; 粉丝数: 2 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 31; 包名: dsh-pace-calc; 描述: 配速计算 — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ❌ 不通过 | try/catch: 0 处, 函数: 4 个, 比例: 0.0% — 未检测到任何 try/catch |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 27, 注释行: 0 (0.0%) |
...
| :--- | :--- |
| 插件名称 | dsh-pace-calc |
| 校验 URL | https://github.com/uckkk/dsh-pace-calc |
| 必查项通过率 | 30/33 (91%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
