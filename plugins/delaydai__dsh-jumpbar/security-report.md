...
- **校验对象**: https://github.com/delaydai/dsh-jumpbar
- **校验时间**: 2026-08-26 01:27:27
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2026-03-24 (154 天前); 公开仓库数: 3; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 350; 包名: dsh-jumpbar; 描述: User message jump bar for the DSH web GUI: a minimap-style dash strip on the rig — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 481, 注释行: 42 (8.7%) |
...
| :--- | :--- |
| 插件名称 | dsh-jumpbar |
| 校验 URL | https://github.com/delaydai/dsh-jumpbar |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
