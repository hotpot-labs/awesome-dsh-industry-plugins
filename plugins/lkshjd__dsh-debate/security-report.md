...
- **校验对象**: https://github.com/lkshjd/dsh-debate
- **校验时间**: 2026-09-06 03:36:02
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 390; 包名: @sky_sun/dsh-debate; 描述: DeepSeek Harness 多 agent 隔离辩论插件：不同底色子 agent 隔离取证、交叉辩论、评审收敛（后台 job + 断点续传 + 波次并行） — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; @deepseek-ai/dsh-tools: ^0.1.0-rc.5; @deepseek-ai/dsh-llm: ^0.1.0-rc.5; @deepseek-ai/dsh-subagent: ^0.1.0-rc.5; @deepseek-ai/dsh-agent: ^0.1.0-rc.5 |
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ✅ 通过 | dsh 配置: {"bundle": {"patch": "./cordis.patch.yml"}}; Cordis/DSH 依赖: @deepseek-ai/cordis, @deepseek-ai/dsh-tools, @deepseek-ai/dsh-llm, @deepseek-ai/dsh-subagent, @deepseek-ai/dsh-agent; Cordis 配置文件: cordis.patch.yml |
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 17 处, 函数: 105 个, 比例: 16.2% |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 1412, 注释行: 229 (16.2%) |
...
| :--- | :--- |
| 插件名称 | dsh-debate |
| 校验 URL | https://github.com/lkshjd/dsh-debate |
| 必查项通过率 | 32/33 (97%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🟡 灰名单 (需人工复核) |
| 主要风险说明 | 详见各检查项结果 |
