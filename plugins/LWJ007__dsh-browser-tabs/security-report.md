...
- **校验对象**: https://github.com/LWJ007/dsh-browser-tabs
- **校验时间**: 2026-08-29 06:13:03
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2017-12-12 (3181 天前); 公开仓库数: 46; 粉丝数: 1 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 214; 包名: dsh-browser-tabs; 描述: DSH plugin: /tabs popupSelect to list and select browser tabs via chrome-devtool — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; @deepseek-ai/dsh-commands: ^0.1.1-rc.2; @deepseek-ai/dsh-tools: ^0.1.1-rc.2; @deepseek-ai/dsh-llm: ^0.1.1-rc.2; @deepseek-ai/dsh-agent: ^0.1.1-rc.2 |
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ✅ 通过 | dsh 配置: {"bundle": {"patch": "./cordis.patch.yml"}, "client": {"inject": ["@deepseek-ai/dsh-client-runtime",; Cordis/DSH 依赖: @deepseek-ai/cordis, @deepseek-ai/dsh-commands, @deepseek-ai/dsh-tools, @deepseek-ai/dsh-llm, @deepseek-ai/dsh-agent; Cordis 配置文件: cordis.patch.yml |
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 3 处, 函数: 22 个, 比例: 13.6% |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - SECURITY.md:11 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:3 → 探测到 HTTP(S) 网络请求 (7 处)<br>  - CHANGELOG.md:5 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - lib/client.js:39 → fetch 网络请求 (1 处)<br>涉及的域名: github.com, img.shields.io, keepachangelog.com, semver.org<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 250, 注释行: 69 (27.6%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-browser-tabs |
| 校验 URL | https://github.com/LWJ007/dsh-browser-tabs |
| 必查项通过率 | 29/33 (88%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
