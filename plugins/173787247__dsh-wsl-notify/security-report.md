...
- **校验对象**: https://github.com/173787247/dsh-wsl-notify
- **校验时间**: 2026-08-31 04:26:10
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 139; 包名: dsh-wsl-notify; 描述: DeepSeek Harness tool: Windows MessageBox notification from WSL. — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ✅ 通过 | try/catch: 3 处, 函数: 16 个, 比例: 18.8% |
...
| 3.7 | 不读取敏感配置 | 必查 | ⚠️  需人工复核 | 检测到敏感配置读取:<br>  - SECURITY.md:3 → 敏感凭证读取 (2 处)<br>  - CONTRIBUTING.md:5 → 敏感凭证读取 (1 处)<br>  - README.md:15 → 敏感凭证读取 (1 处)<br>  - index.js:15 → 敏感凭证读取 (1 处) — 需人工判断是否读取的是当前会话上下文 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 150, 注释行: 1 (0.7%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-notify |
| 校验 URL | https://github.com/173787247/dsh-wsl-notify |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
