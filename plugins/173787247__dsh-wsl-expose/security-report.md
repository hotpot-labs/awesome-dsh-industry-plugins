...
- **校验对象**: https://github.com/173787247/dsh-wsl-expose
- **校验时间**: 2026-09-02 03:32:11
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 56; 包名: dsh-wsl-expose; 描述: Advise or apply allowlisted Windows portproxy for exposing a WSL port. — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 216, 注释行: 0 (0.0%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-expose |
| 校验 URL | https://github.com/173787247/dsh-wsl-expose |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
