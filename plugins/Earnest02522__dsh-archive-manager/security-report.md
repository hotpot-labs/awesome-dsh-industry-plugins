...
- **校验对象**: https://github.com/Earnest02522/dsh-archive-manager
- **校验时间**: 2026-08-27 08:10:57
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2025-03-11 (534 天前); 公开仓库数: 6; 粉丝数: 1 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 1294; 包名: dsh-archive-manager; 描述: Archived-conversation manager for DeepSeek Harness: view (grouped by workspace), — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | @deepseek-ai/cordis: ^4.0.1; @deepseek-ai/dsh-api-gateway: ^0.1.0-rc.6 \|\| ^0.1.1-rc.1; @deepseek-ai/dsh-client-runtime: ^0.1.0-rc.6 \|\| ^0.1.1-rc.1; @deepseek-ai/dsh-typert-protocol: ^0.1.0-rc.6 \|\| ^0.1.1-rc.1; @deepseek-ai/dsh-workspace: ^0.1.0-rc.6 \|\| ^0.1.1-rc.1 |
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ✅ 通过 | dsh 配置: {"bundle": {"patch": "./cordis.patch.yml"}, "client": {"inject": ["@deepseek-ai/dsh-client-runtime",; Cordis/DSH 依赖: @deepseek-ai/cordis, @deepseek-ai/dsh-api-gateway, @deepseek-ai/dsh-client-runtime, @deepseek-ai/dsh-typert-protocol, @deepseek-ai/dsh-workspace; Cordis 配置文件: cordis.patch.yml |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.zh-CN.md:5 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - README.md:5 → 探测到 HTTP(S) 网络请求 (2 处)<br>涉及的域名: github.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 902, 注释行: 123 (13.6%) |
...
| 校验 URL | https://github.com/Earnest02522/dsh-archive-manager |
| 必查项通过率 | 28/33 (85%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
