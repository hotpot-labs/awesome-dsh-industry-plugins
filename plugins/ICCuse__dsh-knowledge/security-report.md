...
- **校验对象**: https://github.com/ICCuse/dsh-knowledge
- **校验时间**: 2026-08-23 16:31:06
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 294; 包名: dsh-knowledge; 描述: Bridge the agent into the user's global Markdown knowledge base (D:\knowledge, s — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 1673, 注释行: 232 (13.9%) |
...
| :--- | :--- |
| 插件名称 | dsh-knowledge |
| 校验 URL | https://github.com/ICCuse/dsh-knowledge |
| 必查项通过率 | 30/33 (91%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🟡 灰名单 (需人工复核) |
| 主要风险说明 | 详见各检查项结果 |
