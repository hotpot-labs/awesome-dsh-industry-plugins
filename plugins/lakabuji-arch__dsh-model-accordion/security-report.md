...
- **校验对象**: https://github.com/lakabuji-arch/dsh-model-accordion
- **校验时间**: 2026-08-25 01:26:03
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2026-04-08 (138 天前); 公开仓库数: 5; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 366; 包名: dsh-model-accordion; 描述: Provider-folded model selector for the DSH Web composer with catalog-driven reas — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ⚠️  需人工复核 | try/catch: 2 处, 函数: 51 个, 比例: 3.9% — try/catch 覆盖比例较低 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:49 → 探测到 HTTP(S) 网络请求 (4 处)<br>  - CHANGELOG.md:5 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com, keepachangelog.com, registry.npmjs.org<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 274, 注释行: 16 (5.8%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-model-accordion |
| 校验 URL | https://github.com/lakabuji-arch/dsh-model-accordion |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
