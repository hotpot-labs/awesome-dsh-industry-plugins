...
- **校验对象**: https://github.com/173787247/dsh-wsl-workspace
- **校验时间**: 2026-09-02 03:32:29
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 57; 包名: dsh-wsl-workspace; 描述: List WSL distros and validate a Linux workspace path for DSH. — README 包含功能/使用说明 |
...
| 3.2 | 无全局文件读写 | 必查 | ⚠️  需人工复核 | 检测到全局文件访问:<br>  - lib/workspace.js:94 → 读取用户主目录 (2 处) — 需人工判断是否有业务必要性 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 236, 注释行: 0 (0.0%) |
...
| 校验 URL | https://github.com/173787247/dsh-wsl-workspace |
| 必查项通过率 | 26/33 (79%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
