...
- **校验对象**: https://github.com/173787247/dsh-wsl-docker
- **校验时间**: 2026-09-02 03:32:02
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 55; 包名: dsh-wsl-docker; 描述: Report Docker Desktop vs WSL docker context confusion. — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 165, 注释行: 0 (0.0%) |
...
| :--- | :--- |
| 插件名称 | dsh-wsl-docker |
| 校验 URL | https://github.com/173787247/dsh-wsl-docker |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
