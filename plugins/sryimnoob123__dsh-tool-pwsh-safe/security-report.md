...
- **校验对象**: https://github.com/sryimnoob123/dsh-tool-pwsh-safe
- **校验时间**: 2026-09-15 03:57:51
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2026-08-07 (38 天前); 公开仓库数: 8; 粉丝数: 3 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 227; 包名: dsh-tool-pwsh-safe; 描述: Elbow-proof PowerShell for DeepSeek Harness: run multiline pwsh scripts via -Enc — README 包含功能/使用说明 |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 2.1 | 明确标注支持的 DSH 版本范围 | 必查 | ✅ 通过 | engines: {"dsh": ">=0.1.0-rc.8", "node": ">=18.0.0"} |
| 2.2 | 遵循 Cordis 插件开发规范 | 必查 | ⚠️  需人工复核 | dsh 配置: {"bundle": {"patch": "./cordis.patch.yml"}}; Cordis 配置文件: cordis.patch.yml<br>  - cordis.patch.yml:1 → Monkey patch / prototype pollution — 发现潜在 hack 模式, 需人工确认 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package.json:35 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - README.md:8 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com, img.shields.io<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 161, 注释行: 21 (13.0%) |
...
| 序号 | 检查项 | 类型 | 结果 | 详情 |
| :--- | :--- | :---: | :---: | :--- |
| 7.1 | 近 3 个月内有更新 | 必查 | ✅ 通过 | 最近提交距今: 20 天; 提交总数: 4 |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-tool-pwsh-safe |
| 校验 URL | https://github.com/sryimnoob123/dsh-tool-pwsh-safe |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
