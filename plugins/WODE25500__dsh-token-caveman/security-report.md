...
- **校验对象**: https://github.com/WODE25500/dsh-token-caveman
- **校验时间**: 2026-09-02 03:36:27
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 105 — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - README.md:7 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - README.zh.md:7 → 探测到 HTTP(S) 网络请求 (3 处)<br>  - skills/caveman/SKILL.md:10 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: github.com, www.npmjs.com<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 64, 注释行: 11 (17.2%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-token-caveman |
| 校验 URL | https://github.com/WODE25500/dsh-token-caveman |
| 必查项通过率 | 24/33 (73%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
