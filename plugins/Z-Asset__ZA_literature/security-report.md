...
- **校验对象**: https://github.com/Z-Asset/ZA_literature
- **校验时间**: 2026-09-19 03:47:46
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 98; 包名: @zasset/za-literature; 描述: Z Research literature stage — literature search, synthesis, and citation-chain t — README 包含功能/使用说明 |
...
| :--- | :--- |
| 插件名称 | ZA_literature |
| 校验 URL | https://github.com/Z-Asset/ZA_literature |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 13/14 (约 93%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
