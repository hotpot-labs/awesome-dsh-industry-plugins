...
- **校验对象**: https://github.com/drscrewdriver/dsh-docx-sidebar
- **校验时间**: 2026-09-25 04:02:50
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 392; 包名: dsh-docx-sidebar; 描述: DSH web plugin (dsh-better-sidebar consumer): render .docx documents as a readab — README 包含功能/使用说明 |
...
| 3.5 | 对外网络请求域名明确 | 必查 | ⚠️  需人工复核 | 检测到网络请求:<br>  - package-lock.json:44 → 探测到 HTTP(S) 网络请求 (39 处)<br>  - README.md:3 → 探测到 HTTP(S) 网络请求 (1 处)<br>  - package.json:55 → 探测到 HTTP(S) 网络请求 (2 处)<br>  - lib/client.js:955 → fetch 网络请求 (1 处)<br>  - scripts/publish-npm.ps1:41 → 探测到 HTTP(S) 网络请求 (1 处)<br>涉及的域名: example.com, github.com, registry.npmjs.org, registry.npmmirror.com, schemas.openxmlformats.org<br>需人工确认每个网络请求的用途是否明确 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 3357, 注释行: 667 (19.9%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-docx-sidebar |
| 校验 URL | https://github.com/drscrewdriver/dsh-docx-sidebar |
| 必查项通过率 | 24/33 (73%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
