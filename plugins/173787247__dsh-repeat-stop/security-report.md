...
- **校验对象**: https://github.com/173787247/dsh-repeat-stop
- **校验时间**: 2026-08-27 08:10:19
...
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 298; 包名: dsh-repeat-stop; 描述: Hard-stop consecutive identical DeepSeek Harness tool calls after a configurable — README 包含功能/使用说明 |
...
| 2.3 | 具备异常捕获机制 | 必查 | ❌ 不通过 | try/catch: 0 处, 函数: 41 个, 比例: 0.0% — 未检测到任何 try/catch |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 268, 注释行: 0 (0.0%) |
...
| 项目 | 内容 |
| :--- | :--- |
| 插件名称 | dsh-repeat-stop |
| 校验 URL | https://github.com/173787247/dsh-repeat-stop |
| 必查项通过率 | 27/33 (82%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
