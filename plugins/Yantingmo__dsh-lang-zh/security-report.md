...
- **校验对象**: https://github.com/Yantingmo/dsh-lang-zh
- **校验时间**: 2026-09-04 03:46:38
...
| 1.2 | 发布账号非匿名一次性账号 | 必查 | ✅ 通过 | 账号注册: 2026-02-17 (198 天前); 公开仓库数: 4; 粉丝数: 0 |
| 1.3 | 开源协议与 MIT 兼容 | 必查 | ✅ 通过 | 许可证: MIT (来自 LICENSE) |
| 1.4 | 核心功能与 README 描述一致 | 必查 | ✅ 通过 | README 字数: 195; 包名: dsh-lang-zh; 描述: Make DeepSeek Harness agents always reply in Simplified Chinese (including the n — README 包含功能/使用说明 |
...
| 4.8 | 代码结构清晰 | 推荐 | ✅ 通过 | 总行数: 36, 注释行: 18 (50.0%) |
...
| :--- | :--- |
| 插件名称 | dsh-lang-zh |
| 校验 URL | https://github.com/Yantingmo/dsh-lang-zh |
| 必查项通过率 | 29/33 (88%) |
| 推荐项满足率 | 14/14 (约 100%) |
| 最终分级 | 🔴 黑名单 |
| 主要风险说明 | 详见各检查项结果 |
